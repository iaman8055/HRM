...
import {getAllEmployeeByStatus,getPresentEmployeeByName} from '../controllers/employees/getEmployee/getAllEmployeeByStatus.js'
...
router.get("/status/search", getPresentEmployeeByName);
